<?php
    ...
    require_once 'sign/rsa_generator.php';
    require_once 'sign/sha1.php';
    require_once 'sign/message.php';
    ...
    $tParams = array(
        ...
        'sectionContent' => phpWrapperFromFile('sections/' . $activeSection . '.php')
    );
